...
set -U fish_user_paths ~/.local/bin ~/.nix-profile/bin /usr/local/bin ~/.cargo/bin ~/miniconda3/bin ~/miniconda3/condabin /sbin /bin /usr/sbin /usr/bin /usr/syno/sbin /usr/syno/bin /usr/local/sbin /usr/local/bin
set -gx LC_ALL C
set -gx EDITOR nvim
